...
SECRET_KEY = 'e6g9dcb547(#(zt$2_o11!0iql*2t+xowploe-)662ca!4#ru7'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(os.path.join(BASE_DIR, 'loanappclient'), 'build'),], #Changed
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = (
    os.path.join(os.path.join(BASE_DIR, 'loanappclient'), 'build', 'static'),
) #Changed

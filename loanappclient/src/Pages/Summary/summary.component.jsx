...
class Summary extends React.Component {
    ...
    render() {
        ...
        if (this.state.docs !== "" || this.state.docs.Status === "OK") {
            addr = <img src={this.props.api + "/media/" + this.state.docs.addr} width="223" height="223" alt="addr"/>
            photo = <img src={this.props.api + "/media/" + this.state.docs.photo} width="223" height="223" alt="photoasd"/>
